...
class PluginPreventivemaintenanceCrontask extends Crontask {

   /**
    * Registra as tarefas cron do plugin
    */
   static function registerCronTasks() {
      CronTask::Register('PluginPreventivemaintenanceCron', 'cronAutoTicket', 
                         HOUR_TIMESTAMP, [
                            'comment'   => __('Create automatic maintenance tickets', 'preventivemaintenance'),
                            'mode'      => CronTask::MODE_EXTERNAL
                         ]);
      
      CronTask::Register('PluginPreventivemaintenanceCron', 'cronSendNotifications', 
                         HOUR_TIMESTAMP, [
                            'comment'   => __('Send maintenance notifications', 'preventivemaintenance'),
                            'mode'      => CronTask::MODE_EXTERNAL
                         ]);
   }
}
